...
for gamma in Gamma:
    for λ in lamda:
        ...
        for train_index, test_index in kf.split(X_trn):
            ...
            hinge_losses.append(compute_hinge_loss_binary(y_pred, y_test))
        hinge_loss_result.append(('Gamma: ' + str(gamma), 'Lamda: ' + str(λ), np.mean(hinge_losses)))

print(hinge_loss_result)
